    ...
    <div className='bg-[#F1F1F1] -mt-40 dark:bg-gray-900'>
      <div className='max-w-6xl mx-auto'>
        ...
        <div className='grid md:grid-cols-3 gap-8 lg:-mt-8 pb-40'>
          {/* Single card */}
          <a
            href='https://web-ferrex.vercel.app'
          ...
          {/* Single card */}
          <a
            href='https://commerce-eg.vercel.app/'
            className='w-full block col-span-3 shadow-2xl'
          >
            <div className='relative overflow-hidden'>
              <img
          ...
          {/* Single card */}
          <a
            href='https://contact-eg.vercel.app'
          ...
          >
            <div className='relative overflow-hidden'>
              ...
              <img
                src='/contact-eg.png'
                alt='EG Software Factory Contact Page'
                className='transform hover:scale-125 transition duration-2000 ease-out'
              />
              <h1 className='absolute top-10 left-10 text-gray-50 font-bold text-xl bg-red-500 rounded-md px-2'>
                Contact Form
          ...
          <div className='grid pt-6 content-around'>
            {/* Single card */}
            <a
              href='https://condel-services.vercel.app'
